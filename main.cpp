...
int main()
{
    cout << "ß@∑~ßÂßÔ!!" << endl << endl;
    cout << "1.•i•H•ø±`´ÿ∫c(πw≥]§j§p¨∞10™∫¬Ì¶C) ©M 3.getSize, getCapacity:" << endl;
    MyString A;
    cout << " [size=" << A.getSize() << ", capacity=" << A.getCapacity() << "]" << endl << endl;
    
    cout << "2.•i•H•Œpush_back / pop_back ©ÒªP•·™F¶Ë" << endl;
    char *str1= "to be ";
    MyString B(str1);
    cout << "' " << B << " '" << " push_back(a) = ";
    ...
    cout << "11.MyString•˝™Ω±µ®œ•Œ§Ω∂}¥˙∏Í, ƒ~©”•ø±`5§¿" << endl;
    char *str2 = "the ";
    ...
    cout << "[findµL] : " << A.find(E) << endl;
    cout << "[find_first_of¶≥] : " << A.find_first_of(E) << endl;
    cout << "[find_first_ofµL] : " << A.find_first_of(F) << endl << endl;
